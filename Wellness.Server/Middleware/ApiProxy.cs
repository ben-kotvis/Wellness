...
namespace Wellness.Server.Middleware
{
    public class ApiProxy
    {
        ...
        public ApiProxy(RequestDelegate nextMiddleware)
        {
        ...
        private Uri BuildTargetUri(HttpRequest request)
        {
            ...
            if (request.Path.StartsWithSegments("/participations", out remainingPath))
            {
                targetUri = new Uri("https://localhost:3500/invoke" + remainingPath);
            }

            if (request.Path.StartsWithSegments("/activities", out remainingPath))
            {
                targetUri = new Uri("https://localhost:3500/invoke" + remainingPath);
            }
